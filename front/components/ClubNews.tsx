...
const events = [
  { id: 1, title: 'Santiago Bernabéu Stadium Tour', image: "/Images/Santiago_Premium.png", category: "Tour", date: "Daily from 9:30 AM", href: "/stadium" },
  { id: 2, title: "Official Club Museum", image: "/Images/Museum_Premium.png", category: "Museum", date: "Permanent Exhibition", href: "/about" },
  { id: 3, title: "Real Madrid City", image: "/Images/City_Premium.png", category: "Academy", date: "Valdebebas", href: "/about" },
];
      ...
      <div className="max-w-[1800px] mx-auto px-4 md:px-20 flex flex-col gap-24 relative z-10">
        ...
        >
          <div className="relative h-[400px] w-full lg:w-[500px] shrink-0 rounded-[60px] overflow-hidden shadow-2xl skew-x-1 group-hover:skew-x-0 transition-transform duration-1000">
            <Image src="/Images/Legacy_Premium.png" alt="Legacy" fill className="object-cover group-hover:scale-105 transition-transform duration-1000 grayscale group-hover:grayscale-0 transition-filter" />
