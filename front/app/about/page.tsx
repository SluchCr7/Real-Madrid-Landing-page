...
export default function AboutPage() {
   ...
   const legends = [
      { name: "Alfredo Di Stéfano", role: "The Saeta Rubia", image: "https://upload.wikimedia.org/wikipedia/commons/c/ca/Alfredo_Di_St%C3%A9fano_1961.jpg" },
      { name: "Cristiano Ronaldo", role: "All-Time Top Scorer", image: "https://upload.wikimedia.org/wikipedia/commons/b/b8/Cristiano_Ronaldo_2012.jpg" },
      { name: "Zinedine Zidane", role: "The Maestro", image: "https://upload.wikimedia.org/wikipedia/commons/4/4b/Zinedine_Zidane_by_Tasnim_03.jpg" },
      { name: "Raúl González", role: "El Capitán", image: "https://upload.wikimedia.org/wikipedia/commons/d/d3/Ra%C3%BAl_Gonz%C3%A1lez_Blanco_02.jpg" },
   ];
      ...
      <div className="flex flex-col w-full bg-background transition-colors duration-500 min-h-screen">
         ...
         <section className="py-24 px-4 md:px-20 max-w-7xl mx-auto w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-40">
               ...
               >
                  <Image src="/Images/About_Fans.png" alt="Club Identity" fill className="object-cover group-hover:scale-105 transition-transform duration-1000 brightness-75" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-40">
               ...
               >
                  <Image src="/Images/Santiago_Premium.png" alt="Santiago Bernabéu" fill className="object-cover group-hover:scale-105 transition-transform duration-[2000ms] brightness-50" />
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                  {legends.map((l, idx) => (
                     <motion.div
                        ...
                        className="group relative h-[650px] rounded-[50px] overflow-hidden shadow-2xl border border-border-subtle hover:border-rm-gold/40 transition-all duration-1000 cursor-pointer"
                     >
                        {/* Darker base background for loading state / fallbacks */}
                        ...
                        <Image
                           ...
                           fill
                           unoptimized
                           className="object-cover object-top group-hover:scale-110 transition-transform duration-[2000ms] grayscale group-hover:grayscale-0 brightness-75 group-hover:brightness-110"
                        />
                        ...
                        <div className="absolute inset-0 bg-gradient-to-tr from-rm-blue-dark/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />

                        <div className="absolute inset-x-0 bottom-0 p-12 flex flex-col gap-3 transform group-hover:translate-y-[-10px] transition-transform duration-700">
                           <div className="flex items-center gap-4">
                              <div className="w-10 h-[1px] bg-rm-gold group-hover:w-20 transition-all duration-700" />
                              <span className="text-rm-gold text-[10px] font-black uppercase tracking-[0.5em] italic leading-none">{l.role}</span>
                           </div>
                           <h4 className="text-5xl font-black uppercase text-white italic tracking-tighter leading-[0.8] group-hover:text-gold transition-colors duration-500 mb-4">{l.name}</h4>

                           <div className="flex items-center gap-4 opacity-0 group-hover:opacity-100 transition-all duration-700 delay-150 translate-y-4 group-hover:translate-y-0">
                              <span className="text-white/40 text-[9px] font-black uppercase tracking-[0.4em] italic">Honor & Legacy</span>
                              <ChevronRight className="w-5 h-5 text-rm-gold" />
                           </div>
                        </div>

                        {/* Premium Glassmorphism Shine */}
                        <div className="absolute top-0 left-[-100%] w-full h-full bg-gradient-to-r from-transparent via-white/[0.05] to-transparent group-hover:left-[100%] transition-all duration-[2000ms] skew-x-12" />
                     </motion.div>
                  ))}
               </div>
            </div>
            ...
            >
               <Image src="/Images/Museum_Premium.png" alt="Final Background" fill className="object-cover brightness-[0.25] group-hover:scale-105 transition-transform duration-[3000ms]" />
